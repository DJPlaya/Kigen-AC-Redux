...
#include "kigen-ac_redux/translations.sp"	// Translations Module - Needs to be first
...
// Version Checker for Handle Type TODO 1.8
#if SOURCEMOD_V_MAJOR == 1
 #if SOURCEMOD_V_MINOR >= 10 // 1.10+
  public void KACR_ClearTimer(Handle timer, any nothing)
  {
  	g_hDenyArray.Clear();
  }
