...
CVars_OnPluginStart()
{
	...
	CVars_AddCVar("cl_cmdrate", COMP_GREATER, ACTION_KICK, "0.0", 0.0, PRIORITY_NORMAL); // There is an Exploit with the CVar beeing filled with Chars #44, if it has chars, it cant be greater than 0.0
